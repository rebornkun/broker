                ...
                <div className='section mnbground first_section backk'>
                    <div className='section_container fdcolumn'>
                        <div className='contents home_first'>
                            <div className=''>
                                <h1 className='slogan_h1 colorchange'><span>Trade</span> Forex<span>,</span>
                    ...
                    <div className='section_container'>
                        <div className='contents home_second'>
                            ...
                            <div className='small_card_container'>
                                ...
                                <SmallCard img={indicesImg} title='Indices' text='19 major global indices'/>
                                <SmallCard img={commoditiesImg} title='Commodities' text='Coffee, natural gas, corn & more'/>
                                <SmallCard img={bondsImg} title='Bonds' text='US10YR & UK Long Gilt Futures GILT'/>
                                <SmallCard img={metalsImg} title='Metals' text='Gold, oil, silver & more'/>
                                <SmallCard img={digitalImg} title='Digital Currencies' text='Bitcoin, Ethereum, Ripple, Bitcoin Cash, Litecoin'/>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className='flex hfc home_third_container'>
                                <div className='ourapproach'>
                                    <div className='ourapproach_text  reveal fade-bottom'>
                                        <p>We have professional traders and world class Trading AIs that run our automated trading. Our AIs and brokers have proven time and time again to make us more resources in folds.</p>
                                    </div>
                            ...
                            <div className='doc'>
                                <div className='fdrow jcsb gap1 fww' style={{marginBottom: '1rem'}}>
                                    ...
                                    <div className='did'>
                                        ...
                                        <p style={{textAlign: 'right'}}>We understand how important having reliable support service is to you. Please don't hesitate to contact us should you have any questions or concerns and we will get back to you in no time.</p>
                                    </div>
                                </div>
                                <div className='fdrow jcsb gap1 fww'>
                                    <div className='did'>
                                        <h5 style={{textAlign: 'left'}}>Security</h5>
                                        <p style={{textAlign: 'left'}}>All data on financial operations as well as personal data are effectively protected with EV SSL certificates and additional services on encryption of data transfer.</p>
                                    </div>
                                    <div className='did'>
                                        <h5 style={{textAlign: 'right'}}>Privacy</h5>
                                        <p style={{textAlign: 'right'}}>We don't require identity verification. Information about your activity on the website is private and can't be accessed by third parties.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className='section pebground' style={{height: 'fit-content'}} >
                    <div className='section_container'>
                        <div className='contents home_fifth'>
                            <h1 className='reveal fade-bottom'>Producing millioniares with our high-end AI and traditional method of trading and investmemt strategies.</h1>
