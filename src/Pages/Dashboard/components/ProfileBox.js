            ...
            <div className='fdrow aic gap05 prof'>
                ...
                <div style={{overflow: 'hidden'}} className='fcolumn gap1'>
                    <div className='fdrow aic gap02'>
                        ...
                        <p style={{textOverflow: 'ellipsis', overflow: 'hidden'}} className='value'>{userData[0]?.full_name}</p>
                    </div>
                    <div className='fdrow aic gap02 mbbb'>
                        {/* <p className='montitle'>Email:</p> */}
                        <p style={{textOverflow: 'ellipsis', overflow: 'hidden'}} className='value'>{userData[0]?.email}</p>
                    </div>
                </div>
            </div>
            <div style={{marginTop: '0.5rem', justifyContent: 'space-evenly'}} className='fdrow gap1'>
